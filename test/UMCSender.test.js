...
const UMCSender = contract.fromArtifact('UMCSender');

describe('UMCSender', function () {
  ...
  beforeEach(async function () {
    ...
    this.sender = await UMCSender.new({ from: creator });
  });
  ...
  it('sends from an externally-owned account', async function () {
    ...
    await expectEvent.inTransaction(receipt.tx, UMCSender, 'DoneStuff', { from: holder, to: recipient, amount: amount, userData: data, operatorData: null });
