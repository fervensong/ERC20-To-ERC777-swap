...
contract UMCToken is Context, IERC777, IERC20, Ownable {
     ...
     */
    constructor(
        address _checqueOperator,
        address _swapOperator
    ) public {
        _name = "United Mankind Coin";
        _symbol = "UMC";

        _mint(msg.sender, msg.sender, 84000000 * 10 ** 18, "", "");

        _defaultOperatorsArray = new address[](0);
        _defaultOperatorsArray.push(_checqueOperator);
        _defaultOperatorsArray.push(_swapOperator);
